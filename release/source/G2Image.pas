...
type
  ...
  public
    ...
    class function CanLoad(const FileName: FileString): Boolean; virtual; overload;
    ...
    procedure Load(const FileName: FileString); virtual; overload;
    ...
    procedure Save(const FileName: FileString); virtual; overload;
...
class function TG2Image.CanLoad(const FileName: FileString): Boolean;
  var dm: TG2DataManager;
begin
...
procedure TG2Image.Load(const FileName: FileString);
  var dm: TG2DataManager;
...
procedure TG2Image.Save(const FileName: FileString);
  var dm: TG2DataManager;
begin
