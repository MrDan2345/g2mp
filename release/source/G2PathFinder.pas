...
type
  ...
  public
    ...
    property HAmp: G2Float read _HAmp write _HAmp;
    property MoveDiag: Boolean read _MoveDiag write _MoveDiag;
    property WallBend: Boolean read _WallBend write _WallBend;
    constructor Create;
    destructor Destroy; override;
    function CreateMap(
      const Width, Height: IntS32;
      const BaseCost: IntS32 = 20;
      const CostH: IntS32 = 10;
      const CostV: IntS32 = 10;
      const CostD: IntS32 = 14
    ): PG2PathMap;
    procedure FreeMap(var Map: PG2PathMap);
    function FindPath(
      const Map: PG2PathMap;
      const StartX, StartY, FinishX, FinishY: IntS32;
...
function TG2PathFinder.FindPath(
  ...
  function GetHeuristic(const X, Y: IntS32): IntS32;
    var DX, DY, sMin, sMax: IntS32;
  begin
...
begin
  ...
  begin
    ...
    begin
      ...
      Move(_LastPath^.Nodes[i]^, WayPoints^[i], SizeOf(IntS32) * 2);
    end;
  end
  else
  begin
