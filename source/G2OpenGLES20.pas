...
var
  ...
  glAttachShader: procedure(programObj, shaderObj: GLhandle); cdecl;
  glBindAttribLocation: procedure(programObj: GLhandle; index: GLuint; name: PChar); cdecl;
  glCompileShader: procedure(shaderObj: GLhandle); cdecl;
  glCreateProgram: function: GLhandle; cdecl;
  glCreateShader: function(shaderType: GLenum): GLhandle; cdecl;
  glDeleteProgram: procedure(programObj: GLhandle); cdecl;
  glDeleteShader: procedure(shaderObj: GLhandle); cdecl;
  glDetachShader: procedure(programObj, shaderObj: GLhandle); cdecl;
  glDisableVertexAttribArray: procedure(index: GLuint); cdecl;
  glEnableVertexAttribArray: procedure(index: GLuint); cdecl;
  glGetActiveAttrib: procedure(programObj: GLhandle; index: GLuint; maxlength: GLsizei; var length: GLint; var _type: GLenum; name: PChar); cdecl;
  glGetActiveUniform: procedure(programObj: GLhandle; index: GLuint; maxLength: GLsizei; var length: GLsizei; var size: GLint; var _type: GLenum; name: PChar); cdecl;
  glGetAttachedShaders: procedure(programObj: GLhandle; MaxCount: GLsizei; var Count: GLint; shaders: PGLuint); cdecl;
  glGetAttribLocation: function(programObj: GLhandle; char: AnsiString): glint; cdecl;
  glGetProgramiv: procedure(programObj: GLhandle; pname: glenum; params: PGLInt); cdecl;
  glGetProgramInfoLog: procedure(programObj: GLHandle; maxLength: glsizei; var length: GLint; infoLog: PChar); cdecl;
  glGetShaderiv: procedure(shaderObj: GLhandle; pname: glenum; params: PGLInt); cdecl;
  glGetShaderInfoLog: procedure(shaderObj: GLHandle; maxLength: glsizei; var length: glint; infoLog: PChar); cdecl;
  glGetShaderSource: procedure(shaderObj: GLhandle; maxlength: GLsizei; var length: GLsizei; source: PChar); cdecl;
  glGetUniformLocation: function(programObj: GLhandle; const char: PChar): glint; cdecl;
  glGetUniformfv: procedure(programObj: GLhandle; location: GLint; params: PGLfloat); cdecl;
  glGetUniformiv: procedure(programObj: GLhandle; location: GLint; params: PGLInt); cdecl;
  ...
  glGetVertexAttribPointerv: procedure(index: GLuint; pname: GLenum; _pointer: PGLvoid); cdecl;
  glIsProgram: function(programObj: GLhandle) : glboolean; cdecl;
  glIsShader: function(shaderObj: GLhandle) : glboolean; cdecl;
  glLinkProgram: procedure(programObj: GLHandle); cdecl;
  glShaderSource: procedure(shaderObj: GLHandle; count: glsizei; _string: PPGLChar; lengths: pglint); cdecl;
  glUseProgram: procedure(programObj: GLhandle); cdecl;
  glUniform1f: procedure(location: GLint; v0: GLfloat); cdecl;
  glUniform2f: procedure(location: GLint; v0, v1: GLfloat); cdecl;
  glUniform3f: procedure(location: GLint; v0, v1, v2: GLfloat); cdecl;
  glUniform4f: procedure(location: GLint; v0, v1, v2, v3: GLfloat); cdecl;
  glUniform1i: procedure(location: GLint; v0: GLint); cdecl;
  glUniform2i: procedure(location: GLint; v0, v1: GLint); cdecl;
  glUniform3i: procedure(location: GLint; v0, v1, v2: GLint); cdecl;
  glUniform4i: procedure(location: GLint; v0, v1, v2, v3: GLint); cdecl;
  ...
  glValidateProgram: procedure(programObj: GLhandle); cdecl;
  glVertexAttrib1d: procedure(index: GLuint; x: GLdouble); cdecl;
  glVertexAttrib1dv: procedure(index: GLuint; const v: PGLdouble); cdecl;
  glVertexAttrib1f: procedure(index: GLuint; x: GLfloat); cdecl;
  glVertexAttrib1fv: procedure(index: GLuint; const v: PGLfloat); cdecl;
  glVertexAttrib1s: procedure(index: GLuint; x: GLshort); cdecl;
  glVertexAttrib1sv: procedure(index: GLuint; const v: PGLshort); cdecl;
  glVertexAttrib2d: procedure(index: GLuint; x: GLdouble; y: GLdouble); cdecl;
  glVertexAttrib2dv: procedure(index: GLuint; const v: PGLdouble); cdecl;
  glVertexAttrib2f: procedure(index: GLuint; x: GLfloat; y: GLfloat); cdecl;
  glVertexAttrib2fv: procedure(index: GLuint; const v: PGLfloat); cdecl;
  glVertexAttrib2s: procedure(index: GLuint; x: GLshort; y: GLshort); cdecl;
  glVertexAttrib2sv: procedure(index: GLuint; const v: PGLshort); cdecl;
  glVertexAttrib3d: procedure(index: GLuint; x: GLdouble; y: GLdouble; z: GLdouble); cdecl;
  glVertexAttrib3dv: procedure(index: GLuint; const v: PGLdouble); cdecl;
  glVertexAttrib3f: procedure(index: GLuint; x: GLfloat; y: GLfloat; z: GLfloat); cdecl;
  glVertexAttrib3fv: procedure(index: GLuint; const v: PGLfloat); cdecl;
  glVertexAttrib3s: procedure(index: GLuint; x: GLshort; y: GLshort; z: GLshort); cdecl;
  glVertexAttrib3sv: procedure(index: GLuint; const v: PGLshort); cdecl;
  glVertexAttrib4Nbv: procedure(index: GLuint; const v: PGLbyte); cdecl;
  glVertexAttrib4Niv: procedure(index: GLuint; const v: PGLint); cdecl;
  glVertexAttrib4Nsv: procedure(index: GLuint; const v: PGLshort); cdecl;
  glVertexAttrib4Nub: procedure(index: GLuint; x: GLubyte; y: GLubyte; z: GLubyte; w: GLubyte); cdecl;
  glVertexAttrib4Nubv: procedure(index: GLuint; const v: PGLubyte); cdecl;
  glVertexAttrib4Nuiv: procedure(index: GLuint; const v: PGLuint); cdecl;
  glVertexAttrib4Nusv: procedure(index: GLuint; const v: PGLushort); cdecl;
  glVertexAttrib4bv: procedure(index: GLuint; const v: PGLbyte); cdecl;
  glVertexAttrib4d: procedure(index: GLuint; x: GLdouble; y: GLdouble; z: GLdouble; w: GLdouble); cdecl;
  glVertexAttrib4dv: procedure(index: GLuint; const v: PGLdouble); cdecl;
  glVertexAttrib4f: procedure(index: GLuint; x: GLfloat; y: GLfloat; z: GLfloat; w: GLfloat); cdecl;
  glVertexAttrib4fv: procedure(index: GLuint; const v: PGLfloat); cdecl;
  glVertexAttrib4iv: procedure(index: GLuint; const v: PGLint); cdecl;
  glVertexAttrib4s: procedure(index: GLuint; x: GLshort; y: GLshort; z: GLshort; w: GLshort); cdecl;
  glVertexAttrib4sv: procedure(index: GLuint; const v: PGLshort); cdecl;
  glVertexAttrib4ubv: procedure(index: GLuint; const v: PGLubyte); cdecl;
  glVertexAttrib4uiv: procedure(index: GLuint; const v: PGLuint); cdecl;
  glVertexAttrib4usv: procedure(index: GLuint; const v: PGLushort); cdecl;
  glVertexAttribPointer: procedure(index: GLuint; size: GLint; _type: GLenum; normalized: GLboolean; stride: GLsizei; const _pointer: PGLvoid); cdecl;
...
begin
  ...
  Pointer(glAttachShader) := glProc('glAttachShader');
  Pointer(glBindAttribLocation) := glProc('glBindAttribLocation');
  Pointer(glCompileShader) := glProc('glCompileShader');
  Pointer(glCreateProgram) := glProc('glCreateProgram');
  Pointer(glCreateShader) := glProc('glCreateShader');
  Pointer(glDeleteProgram) := glProc('glDeleteProgram');
  Pointer(glDeleteShader) := glProc('glDeleteShader');
  Pointer(glDetachShader) := glProc('glDetachShader');
  Pointer(glDisableVertexAttribArray) := glProc('glDisableVertexAttribArray');
  Pointer(glEnableVertexAttribArray) := glProc('glEnableVertexAttribArray');
  Pointer(glGetActiveAttrib) := glProc('glGetActiveAttrib');
  Pointer(glGetActiveUniform) := glProc('glGetActiveUniform');
  Pointer(glGetAttachedShaders) := glProc('glGetAttachedShaders');
  Pointer(glGetAttribLocation) := glProc('glGetAttribLocation');
  Pointer(glGetProgramiv) := glProc('glGetProgramiv');
  Pointer(glGetProgramInfoLog) := glProc('glGetProgramInfoLog');
  Pointer(glGetShaderiv) := glProc('glGetShaderiv');
  Pointer(glGetShaderInfoLog) := glProc('glGetShaderInfoLog');
  Pointer(glGetShaderSource) := glProc('glGetShaderSource');
  Pointer(glGetUniformLocation) := glProc('glGetUniformLocation');
  Pointer(glGetUniformfv) := glProc('glGetUniformfv');
  Pointer(glGetUniformiv) := glProc('glGetUniformiv');
  Pointer(glGetVertexAttribfv) := glProc('glGetVertexAttribfv');
  Pointer(glGetVertexAttribiv) := glProc('glGetVertexAttribiv');
  Pointer(glGetVertexAttribPointerv) := glProc('glGetVertexAttribPointerv');
  Pointer(glIsProgram) := glProc('glIsProgram');
  Pointer(glIsShader) := glProc('glIsShader');
  Pointer(glLinkProgram) := glProc('glLinkProgram');
  Pointer(glShaderSource) := glProc('glShaderSource');
  Pointer(glUseProgram) := glProc('glUseProgram');
  Pointer(glUniform1f) := glProc('glUniform1f');
  Pointer(glUniform2f) := glProc('glUniform2f');
  Pointer(glUniform3f) := glProc('glUniform3f');
  Pointer(glUniform4f) := glProc('glUniform4f');
  Pointer(glUniform1i) := glProc('glUniform1i');
  Pointer(glUniform2i) := glProc('glUniform2i');
  Pointer(glUniform3i) := glProc('glUniform3i');
  Pointer(glUniform4i) := glProc('glUniform4i');
  Pointer(glUniform1fv) := glProc('glUniform1fv');
  Pointer(glUniform2fv) := glProc('glUniform2fv');
  Pointer(glUniform3fv) := glProc('glUniform3fv');
  Pointer(glUniform4fv) := glProc('glUniform4fv');
  Pointer(glUniform1iv) := glProc('glUniform1iv');
  Pointer(glUniform2iv) := glProc('glUniform2iv');
  Pointer(glUniform3iv) := glProc('glUniform3iv');
  Pointer(glUniform4iv) := glProc('glUniform4iv');
  Pointer(glUniformMatrix2fv) := glProc('glUniformMatrix2fv');
  Pointer(glUniformMatrix3fv) := glProc('glUniformMatrix3fv');
  Pointer(glUniformMatrix4fv) := glProc('glUniformMatrix4fv');
  Pointer(glValidateProgram) := glProc('glValidateProgram');
  Pointer(glVertexAttrib1d) := glProc('glVertexAttrib1d');
  Pointer(glVertexAttrib1dv) := glProc('glVertexAttrib1dv');
  Pointer(glVertexAttrib1f) := glProc('glVertexAttrib1f');
  Pointer(glVertexAttrib1fv) := glProc('glVertexAttrib1fv');
  Pointer(glVertexAttrib1s) := glProc('glVertexAttrib1s');
  Pointer(glVertexAttrib1sv) := glProc('glVertexAttrib1sv');
  Pointer(glVertexAttrib2d) := glProc('glVertexAttrib2d');
  Pointer(glVertexAttrib2dv) := glProc('glVertexAttrib2dv');
  Pointer(glVertexAttrib2f) := glProc('glVertexAttrib2f');
  Pointer(glVertexAttrib2fv) := glProc('glVertexAttrib2fv');
  Pointer(glVertexAttrib2s) := glProc('glVertexAttrib2s');
  Pointer(glVertexAttrib2sv) := glProc('glVertexAttrib2sv');
  Pointer(glVertexAttrib3d) := glProc('glVertexAttrib3d');
  Pointer(glVertexAttrib3dv) := glProc('glVertexAttrib3dv');
  Pointer(glVertexAttrib3f) := glProc('glVertexAttrib3f');
  Pointer(glVertexAttrib3fv) := glProc('glVertexAttrib3fv');
  Pointer(glVertexAttrib3s) := glProc('glVertexAttrib3s');
  Pointer(glVertexAttrib3sv) := glProc('glVertexAttrib3sv');
  Pointer(glVertexAttrib4Nbv) := glProc('glVertexAttrib4Nbv');
  Pointer(glVertexAttrib4Niv) := glProc('glVertexAttrib4Niv');
  Pointer(glVertexAttrib4Nsv) := glProc('glVertexAttrib4Nsv');
  Pointer(glVertexAttrib4Nub) := glProc('glVertexAttrib4Nub');
  Pointer(glVertexAttrib4Nubv) := glProc('glVertexAttrib4Nubv');
  Pointer(glVertexAttrib4Nuiv) := glProc('glVertexAttrib4Nuiv');
  Pointer(glVertexAttrib4Nusv) := glProc('glVertexAttrib4Nusv');
  Pointer(glVertexAttrib4bv) := glProc('glVertexAttrib4bv');
  Pointer(glVertexAttrib4d) := glProc('glVertexAttrib4d');
  Pointer(glVertexAttrib4dv) := glProc('glVertexAttrib4dv');
  Pointer(glVertexAttrib4f) := glProc('glVertexAttrib4f');
  Pointer(glVertexAttrib4fv) := glProc('glVertexAttrib4fv');
  Pointer(glVertexAttrib4iv) := glProc('glVertexAttrib4iv');
  Pointer(glVertexAttrib4s) := glProc('glVertexAttrib4s');
  Pointer(glVertexAttrib4sv) := glProc('glVertexAttrib4sv');
  Pointer(glVertexAttrib4ubv) := glProc('glVertexAttrib4ubv');
  Pointer(glVertexAttrib4uiv) := glProc('glVertexAttrib4uiv');
  Pointer(glVertexAttrib4usv) := glProc('glVertexAttrib4usv');
  Pointer(glVertexAttribPointer) := glProc('glVertexAttribPointer');
end;
