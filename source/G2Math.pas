...
type
  ...
  private
    ...
    function GetAxisX: TG2Vec3Ref; inline;
    function GetAxisY: TG2Vec3Ref; inline;
    function GetAxisZ: TG2Vec3Ref; inline;
    procedure SetAxisX(const Value: TG2Vec3Ref); inline;
    procedure SetAxisY(const Value: TG2Vec3Ref); inline;
    procedure SetAxisZ(const Value: TG2Vec3Ref); inline;
    procedure SetMat(const ix, iy: TG2IntS32; const Value: TG2Float); inline;
    function GetTranslation: TG2Vec3Ref; inline;
    procedure SetTranslation(const Value: TG2Vec3Ref); inline;
  public
    var Arr: array [0..15] of TG2Float;
    ...
    property Translation: TG2Vec3Ref read GetTranslation write SetTranslation;
    property AxisX: TG2Vec3Ref read GetAxisX write SetAxisX;
    property AxisY: TG2Vec3Ref read GetAxisY write SetAxisY;
    property AxisZ: TG2Vec3Ref read GetAxisZ write SetAxisZ;
    procedure SetValue(
    ...
    function Transpose: TG2Mat; inline;
    function Inverse: TG2Mat; inline;
  ...
  TG2Frustum = object
  private
    var _Planes: array[0..5] of TG2Plane;
    var _RefV: PG2Mat;
    var _RefP: PG2Mat;
  ...
  TG2Rotation2 = object
  private
    function GetAngle: TG2Float; inline;
    function GetAxisX: TG2Vec2;
    function GetAxisY: TG2Vec2;
    procedure SetAngle(const Angle: TG2Float); inline;
    procedure SetAxisX(const Value: TG2Vec2);
    procedure SetAxisY(const Value: TG2Vec2);
  public
    var s, c: TG2Float;
    property Angle: TG2Float read GetAngle write SetAngle;
    property AxisX: TG2Vec2 read GetAxisX write SetAxisX;
    property AxisY: TG2Vec2 read GetAxisY write SetAxisY;
    procedure SetValue(const rs, rc: TG2Float); inline;
    procedure SetIdentity; inline;
    procedure Normalize; inline;
    function Transform(const v: TG2Vec2): TG2Vec2; inline;
    function TransformInv(const v: TG2Vec2): TG2Vec2; inline;
  end;
  PG2Rotation2 = ^TG2Rotation2;

  TG2Transform2 = object
  public
    var p: TG2Vec2;
    var r: TG2Rotation2;
    procedure SetValue(const tp: TG2Vec2; const tr: TG2Rotation2); inline;
    procedure SetIdentity; inline;
    function Transform(const v: TG2Vec2): TG2Vec2; inline;
    function TransformInv(const v: TG2Vec2): TG2Vec2; inline;
  end;
  PG2Transform2 = ^TG2Transform2;
  ...
  operator := (v: TG2Vec2) vr: TG2Vec2Ref; inline;
  operator := (vr: TG2Vec2Ref) v: TG2Vec2; inline;
  operator := (v: TG2Vec2) pr: TPoint; inline;
  ...
  operator := (r: TRect) rr: TG2Rect; inline;
  operator := (b: TG2Box) rb: TG2AABox; inline;
  ...
  operator - (v0, v1: TG2Vec3) vr: TG2Vec3; inline;
  operator - (v: TG2Vec2; f: TG2Float) vr: TG2Vec2; inline;
  operator - (v: TG2Vec3; f: TG2Float) vr: TG2Vec3; inline;
  operator - (v: TG2Vec4; f: TG2Float) vr: TG2Vec4; inline;
  operator - (v: TG2Vec2; p: TPoint) vr: TG2Vec2; inline;
  operator - (p: TPoint; v: TG2Vec2) vr: TG2Vec2; inline;
  operator + (v0, v1: TG2Vec2) vr: TG2Vec2; inline;
  operator + (v0, v1: TG2Vec3) vr: TG2Vec3; inline;
  operator + (v: TG2Vec2; f: TG2Float) vr: TG2Vec2; inline;
  operator + (v: TG2Vec3; f: TG2Float) vr: TG2Vec3; inline;
  operator + (v: TG2Vec4; f: TG2Float) vr: TG2Vec4; inline;
  operator + (f: TG2Float; v: TG2Vec2) vr: TG2Vec2; inline;
  operator + (f: TG2Float; v: TG2Vec3) vr: TG2Vec3; inline;
  operator + (f: TG2Float; v: TG2Vec4) vr: TG2Vec4; inline;
  operator + (b: TG2AABox; v: TG2Vec3) rb: TG2AABox; inline;
  operator + (v: TG2Vec2; p: TPoint) vr: TG2Vec2; inline;
  operator + (p: TPoint; v: TG2Vec2) vr: TG2Vec2; inline;
  operator * (v: TG2Vec2; f: TG2Float) vr: TG2Vec2; inline;
  operator * (v: TG2Vec3; f: TG2Float) vr: TG2Vec3; inline;
  ...
  operator * (f: TG2Float; v: TG2Vec3) vr: TG2Vec3; inline;
  operator * (f: TG2Float; v: TG2Vec4) vr: TG2Vec4; inline;
  operator * (v0: TG2Vec2; v1: TG2Vec2) vr: TG2Vec2; inline;
  operator * (v0: TG2Vec3; v1: TG2Vec3) vr: TG2Vec3; inline;
  operator * (v0: TG2Vec4; v1: TG2Vec4) vr: TG2Vec4; inline;
  operator * (v: TG2Vec2; m: TG2Mat) vr: TG2Vec2; inline;
  operator * (v: TG2Vec3; m: TG2Mat) vr: TG2Vec3; inline;
  operator * (m0, m1: TG2Mat) mr: TG2Mat; inline;
  operator / (v: TG2Vec2; f: TG2Float) vr: TG2Vec2; inline;
  operator / (v: TG2Vec3; f: TG2Float) vr: TG2Vec3; inline;
  operator = (v0, v1: TG2Vec2): Boolean; inline;
  operator = (v0, v1: TG2Vec3): Boolean; inline;
  operator = (v0, v1: TG2Vec4): Boolean; inline;
  operator = (q0, q1: TG2Quat): Boolean; inline;
  operator = (m0, m1: TG2Mat): Boolean; inline;

function G2Rect(const x, y, w, h: TG2Float): TG2Rect; inline;
function G2Vec2: TG2Vec2; inline;
function G2Vec2(const x, y: TG2Float): TG2Vec2; inline;
function G2Vec2(const pt: TPoint): TG2Vec2; inline;
function G2Vec2InRect(const v: TG2Vec2; const r: TG2Rect): Boolean; inline;
function G2Vec2InPoly(const v: TG2Vec2; const VArr: PG2Vec2; const VCount: TG2IntS32): Boolean;
function G2Vec3: TG2Vec3; inline;
function G2Vec3(const x, y, z: TG2Float): TG2Vec3; inline; overload;
function G2Vec3(const v2: TG2Vec2; const z: TG2Float): TG2Vec3; inline; overload;
function G2Vec4: TG2Vec4; inline;
function G2Vec4(const x, y, z, w: TG2Float): TG2Vec4; inline;
function G2Rotation2: TG2Rotation2; inline; overload;
function G2Rotation2(const s, c: TG2Float): TG2Rotation2; inline; overload;
function G2Rotation2(const Angle: TG2Float): TG2Rotation2; inline; overload;
function G2Transform2: TG2Transform2; inline; overload;
function G2Transform2(const p: TG2Vec2; const r: TG2Rotation2): TG2Transform2; inline;
function G2Quat: TG2Quat; inline;
function G2Quat(const x, y, z, w: TG2Float): TG2Quat; inline;
function G2Quat(const Axis: TG2Vec3; const Angle: TG2Float): TG2Quat; inline;
function G2Quat(const m: TG2Mat): TG2Quat; inline;
function G2QuatDot(const q0, q1: TG2Quat): TG2Float; inline;
...
function G2Mat(const AxisX, AxisY, AxisZ, Translation: TG2Vec3): TG2Mat; inline;
function G2MatIdentity: TG2Mat; inline;
function G2MatZero: TG2Mat; inline;
function G2MatScaling(const x, y, z: TG2Float): TG2Mat; inline;
function G2MatScaling(const v: TG2Vec3): TG2Mat; inline;
function G2MatScaling(const s: TG2Float): TG2Mat; inline;
function G2MatTranslation(const x, y, z: TG2Float): TG2Mat; inline;
function G2MatTranslation(const v: TG2Vec3): TG2Mat; inline;
function G2MatRotationX(const a: TG2Float): TG2Mat; inline;
function G2MatRotationY(const a: TG2Float): TG2Mat; inline;
function G2MatRotationZ(const a: TG2Float): TG2Mat; inline;
function G2MatRotation(const x, y, z, a: TG2Float): TG2Mat; inline;
function G2MatRotation(const v: TG2Vec3; const a: TG2Float): TG2Mat; inline;
function G2MatRotation(const q: TG2Quat): TG2Mat; inline;
function G2MatView(const Pos, Target, Up: TG2Vec3): TG2Mat; inline;
function G2MatOrth(const Width, Height, ZNear, ZFar: TG2Float): TG2Mat; inline;
function G2MatOrth2D(const Width, Height, ZNear, ZFar: TG2Float; const FlipH: Boolean = False; const FlipV: Boolean = True): TG2Mat; inline;
function G2MatProj(const FOV, Aspect, ZNear, ZFar: TG2Float): TG2Mat; inline;
function G2MatTranspose(const m: TG2Mat): TG2Mat; inline;
procedure G2MatDecompose(const OutScaling: PG2Vec3; const OutRotation: PG2Quat; const OutTranslation: PG2Vec3; const m: TG2Mat);
function G2MatCompare(const m0, m1: TG2Mat): Boolean; inline;
...
function G2Project2DPointToLine(const lv0, lv1, v: TG2Vec2; var InSegment: Boolean): TG2Vec2;
function G2Project3DPointToLine(const lv0, lv1, v: TG2Vec3; var InSegment: Boolean): TG2Vec3;
function G2Project3DPointToPlane(const p: TG2Plane; const v: TG2Vec3): TG2Vec3;

function G2Intersect2DLineVsLine(const l0v0, l0v1, l1v0, l1v1: TG2Vec2; var xp: TG2Vec2): Boolean;
function G2Intersect2DLineVsSegment(const l0, l1, s0, s1: TG2Vec2; var xp: TG2Vec2): Boolean;
function G2Intersect2DSegmentVsSegment(const s0v0, s0v1, s1v0, s1v1: TG2Vec2; var xp: TG2Vec2): Boolean;
function G2Intersect2DLineVsCircle(const lv0, lv1, cc: TG2Vec2; const r: TG2Float; var xp0, xp1: TG2Vec2): Boolean;
function G2Intersect2DSegmentVsCircle(const lv0, lv1, cc: TG2Vec2; const r: TG2Float; var xp0, xp1: TG2Vec2; var xb0, xb1: Boolean): Boolean;
function G2Intersect2DLineVsRect(const lv0, lv1: TG2Vec2; const r: TG2Rect; var xp0, xp1: TG2Vec2): Boolean;
function G2Intersect2DSegmentVsRect(const lv0, lv1: TG2Vec2; const r: TG2Rect; var xp0, xp1: TG2Vec2): Boolean;
function G2Intersect3DLineVsPlane(const lv0, lv1: TG2Vec3; const p: TG2Plane; var xp: TG2Vec3): Boolean;
function G2Intersect3DLineVsSphere(const lv0, lv1: TG2Vec3; const s: TG2Sphere; var xp0, xp1: TG2Vec3): Boolean;
function G2Intersect3Planes(const p1, p2, p3: TG2Plane; var xp: TG2Vec3): Boolean;
function G2Intersect3DRayVsPlane(const r: TG2Ray3; const p: TG2Plane; var xp: TG2Vec3; var xd: TG2Float): Boolean;
function G2Intersect3DRayVsTriangle(const r: TG2Ray3; const v0, v1, v2: TG2Vec3; var xp: TG2Vec3; var xd: TG2Float): Boolean;

function G2Distance3DLineToLine(const l0v0, l0v1, l1v0, l1v1: TG2Vec3; var d0, d1: TG2Vec3): TG2Float;
function G2Distance3DSegmentToSegment(const l0v0, l0v1, l1v0, l1v1: TG2Vec3): TG2Float;

function G2TriangleArea(const v0, v1, v2: TG2Vec2): TG2Float; overload;
function G2TriangleArea(const v0, v1, v2: TG2Vec3): TG2Float; overload;
function G2TriangleNormal(const v0, v1, v2: TG2Vec3): TG2Vec3;
procedure G2TriangleTBN(const v1, v2, v3: TG2Vec3; const uv1, uv2, uv3: TG2Vec2; var T, B, N: TG2Vec3);
...
procedure G2Vec2Rotation2Mul(const OutV, InV: PG2Vec2; const InR: PG2Rotation2); inline;
procedure G2Vec2Rotation2MulInv(const OutV, InV: PG2Vec2; const InR: PG2Rotation2); inline;
procedure G2Vec2Transform2Mul(const OutV, InV: PG2Vec2; const InT: PG2Transform2); inline;
procedure G2Vec2Transform2MulInv(const OutV, InV: PG2Vec2; const InT: PG2Transform2); inline;
...
procedure G2Rotation2Mul(const OutR, InR1, InR2: PG2Rotation2); inline;
procedure G2Rotation2MulInv(const OutR, InR1, InR2: PG2Rotation2); inline;
procedure G2Transform2Mul(const OutT, InT1, InT2: PG2Transform2); //inline;
procedure G2Transform2MulInv(const OutT, InT1, InT2: PG2Transform2); inline;
...
function TG2Mat.GetAxisX: TG2Vec3Ref;
begin
  Result := PG2Vec3(@Arr[0])^;
end;

function TG2Mat.GetAxisY: TG2Vec3Ref;
begin
  Result := PG2Vec3(@Arr[4])^;
end;

function TG2Mat.GetAxisZ: TG2Vec3Ref;
begin
  Result := PG2Vec3(@Arr[8])^;
end;

procedure TG2Mat.SetAxisX(const Value: TG2Vec3Ref);
begin
  PG2Vec3(@Arr[0])^ := Value;
end;

procedure TG2Mat.SetAxisY(const Value: TG2Vec3Ref);
begin
  PG2Vec3(@Arr[4])^ := Value;
end;

procedure TG2Mat.SetAxisZ(const Value: TG2Vec3Ref);
begin
  PG2Vec3(@Arr[8])^ := Value;
end;
...
begin
  Result := PG2Vec3(@Arr[12])^;
end;

procedure TG2Mat.SetTranslation(const Value: TG2Vec3Ref);
begin
  PG2Vec3(@Arr[12])^ := Value;
end;
...
//TG2Ray3 BEGIN
function TG2Ray3.GetArr(const Index: TG2IntS32): TG2Float;
begin
  Result := PG2FloatArr(@Origin.x)^[Index];
end;

procedure TG2Ray3.SetArr(const Index: TG2IntS32; const Value: TG2Float);
begin
  PG2FloatArr(@Origin.x)^[Index] := Value;
end;

procedure TG2Ray3.SetValue(const ROrigin, RDir: TG2Vec3);
begin
...
begin
  ...
  //4 - Near
  //5 - Far
  G2Intersect3Planes(_Planes[4], _Planes[0], _Planes[2], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[5], _Planes[0], _Planes[2], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[4], _Planes[2], _Planes[1], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[5], _Planes[2], _Planes[1], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[4], _Planes[1], _Planes[3], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[5], _Planes[1], _Planes[3], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[4], _Planes[3], _Planes[0], pv^); Inc(pv);
  G2Intersect3Planes(_Planes[5], _Planes[3], _Planes[0], pv^);
end;
...
//TG2Rotation2 BEGIN
function TG2Rotation2.GetAngle: TG2Float;
begin
...
procedure TG2Rotation2.SetAngle(const Angle: TG2Float);
begin
  G2SinCos(Angle, s, c);
end;

procedure TG2Rotation2.SetValue(const rs, rc: TG2Float);
begin
  s := rs; c := rc;
end;

procedure TG2Rotation2.SetIdentity;
begin
  s := 0; c := 1;
end;

procedure TG2Rotation2.Normalize;
begin
  G2Vec2Norm(@Self, @Self);
end;

function TG2Rotation2.Transform(const v: TG2Vec2): TG2Vec2;
begin
  G2Vec2Rotation2Mul(@Result, @v, @Self);
end;

function TG2Rotation2.TransformInv(const v: TG2Vec2): TG2Vec2;
begin
  G2Vec2Rotation2MulInv(@Result, @v, @Self);
end;
//TG2Rotation2 END

//TG2Transform2 BEGIN
procedure TG2Transform2.SetValue(const tp: TG2Vec2; const tr: TG2Rotation2);
begin
  p := tp; r := tr;
end;

procedure TG2Transform2.SetIdentity;
begin
  p.SetZero;
  r.SetIdentity;
end;

function TG2Transform2.Transform(const v: TG2Vec2): TG2Vec2;
begin
  G2Vec2Transform2Mul(@Result, @v, @Self);
end;

function TG2Transform2.TransformInv(const v: TG2Vec2): TG2Vec2;
begin
  G2Vec2Transform2MulInv(@Result, @v, @Self);
end;
//TG2Transform2 END
...
operator + (f: TG2Float; v: TG2Vec2) vr: TG2Vec2;
begin
  vr.x := v.x + f;
  vr.y := v.y + f;
end;

operator + (f: TG2Float; v: TG2Vec3) vr: TG2Vec3;
begin
  vr.x := v.x + f;
  vr.y := v.y + f;
  vr.z := v.z + f;
...
operator + (f: TG2Float; v: TG2Vec4) vr: TG2Vec4;
begin
  vr.x := v.x + f;
  vr.y := v.y + f;
  vr.z := v.z + f;
...
operator * (v0: TG2Vec2; v1: TG2Vec2) vr: TG2Vec2;
begin
  vr.x := v0.x * v1.x;
  vr.y := v0.y * v1.y;
end;

operator * (v0: TG2Vec3; v1: TG2Vec3) vr: TG2Vec3;
begin
  vr.x := v0.x * v1.x;
  vr.y := v0.y * v1.y;
  vr.z := v0.z * v1.z;
...
operator * (v0: TG2Vec4; v1: TG2Vec4) vr: TG2Vec4;
begin
  vr.x := v0.x * v1.x;
  vr.y := v0.y * v1.y;
  vr.z := v0.z * v1.z;
...
operator = (v0, v1: TG2Vec2): Boolean;
begin
  Result := (Abs(v0.x - v1.x) < G2EPS) and (Abs(v0.y - v1.y) < G2EPS);
end;

operator = (v0, v1: TG2Vec3): Boolean;
begin
  Result := (Abs(v0.x - v1.x) < G2EPS) and (Abs(v0.y - v1.y) < G2EPS) and (Abs(v0.z - v1.z) < G2EPS);
end;

operator = (v0, v1: TG2Vec4): Boolean;
begin
  Result := (Abs(v0.x - v1.x) < G2EPS) and (Abs(v0.y - v1.y) < G2EPS) and (Abs(v0.z - v1.z) < G2EPS) and (Abs(v0.w - v1.w) < G2EPS);
end;

operator = (q0, q1: TG2Quat): Boolean;
begin
  Result := (Abs(q0.x - q1.x) < G2EPS) and (Abs(q0.y - q1.y) < G2EPS) and (Abs(q0.z - q1.z) < G2EPS) and (Abs(q0.w - q1.w) < G2EPS);
end;

operator = (m0, m1: TG2Mat): Boolean;
  var i: Integer;
begin
  for i := 0 to 15 do
  if Abs(m0.Arr[i] - m1.Arr[i]) >= G2EPS then Exit(False);
  Result := True;
end;
...
function G2Vec2InRect(const v: TG2Vec2; const r: TG2Rect): Boolean;
begin
  Result := (
    (v.x >= r.l)
    and (v.x <= r.r)
...
function G2Rotation2: TG2Rotation2;
begin
  Result.SetIdentity;
end;

function G2Rotation2(const s, c: TG2Float): TG2Rotation2;
begin
  Result.SetValue(s, c);
end;

function G2Rotation2(const Angle: TG2Float): TG2Rotation2;
begin
  Result.SetAngle(Angle);
end;

function G2Transform2: TG2Transform2;
begin
  Result.SetIdentity;
end;

function G2Transform2(const p: TG2Vec2; const r: TG2Rotation2): TG2Transform2;
begin
  Result.p := p; Result.r := r;
end;

function G2Quat: TG2Quat;
begin
...
function G2MatCompare(const m0, m1: TG2Mat): Boolean;
  var i: TG2IntS32;
begin
  Result := True;
  for i := 0 to 15 do
  if Abs(m0.Arr[i] - m1.Arr[i]) > G2EPS then
  begin
    Result := False;
    Exit;
  end;
...
function G2Vec2Bezier(const v0, v1, v2, v3: TG2Vec2; const t: TG2Float): TG2Vec2;
  var t2, t3: TG2Float;
begin
  t2 := t * t;
  t3 := t2 * t;
...
begin
  ...
  n := (l1v1 - l1v0).Perp;
  nv := n.Dot(v);
  if Abs(nv) < G2EPS then Exit(False);
...
function G2Intersect2DSegmentVsSegment(
  const s0v0, s0v1, s1v0, s1v1: TG2Vec2;
  var xp: TG2Vec2
): Boolean;
  var u: TG2Vec2 absolute s0v0;
  var v, n, d: TG2Vec2;
  var t, nv: TG2Float;
begin
  v := s0v1 - s0v0;
...
function G2Intersect2DLineVsCircle(const lv0, lv1, cc: TG2Vec2; const r: TG2Float; var xp0, xp1: TG2Vec2): Boolean;
  var g, v: TG2Vec2;
  var a, b, c, d, d_sqrt, a2: TG2Float;
begin
  g := lv0 - cc;
  v := lv0 - lv1;
  a := v.Dot(v);
...
function G2Intersect2DSegmentVsCircle(const lv0, lv1, cc: TG2Vec2; const r: TG2Float; var xp0, xp1: TG2Vec2; var xb0, xb1: Boolean): Boolean;
  var g, v: TG2Vec2;
  var a, b, c, d, d_sqrt, a2, p0, p1: TG2Float;
begin
  g := lv0 - cc;
  v := lv1 - lv0;
  a := v.Dot(v);
...
function G2Intersect3DLineVsPlane(const lv0, lv1: TG2Vec3; const p: TG2Plane; var xp: TG2Vec3): Boolean;
  var u: TG2Vec3 absolute lv0;
  var v: TG2Vec3;
  var vn, t: TG2Float;
begin
  v := lv1 - lv0;
  vn := v.Dot(p.n);
  if Abs(vn) < G2EPS then Exit(False);
  t := (p.d - p.n.Dot(u)) / vn;
  xp := u + v * t;
  Result := True;
end;
...
begin
  dn := r.Dir.Dot(p.n);
  if Abs(dn) < G2EPS then Exit(False);
...
function G2Intersect3DRayVsTriangle(const r: TG2Ray3; const v0, v1, v2: TG2Vec3; var xp: TG2Vec3; var xd: TG2Float): Boolean;
  var e1, e2, p, q, d: TG2Vec3;
  var det, det_rcp, u, v, t: TG2Float;
begin
  e1 := v1 - v0;
  e2 := v2 - v0;
  p := r.Dir.Cross(e2);
  det := e1.Dot(p);
  if (det > -G2EPS) and (det < G2EPS) then Exit(False);
  det_rcp := 1 / det;
  d := r.Origin - v0;
  u := d.Dot(p) * det_rcp;
...
function G2Distance3DLineToLine(const l0v0, l0v1, l1v0, l1v1: TG2Vec3; var d0, d1: TG2Vec3): TG2Float;
  var u, v, w: TG2Vec3;
  var a, b, c, d, e, dv, sc, tc: TG2Float;
begin
  u := l0v1 - l0v0;
  v := l1v1 - l1v0;
  w := l0v0 - l1v0;
...
function G2Distance3DSegmentToSegment(const l0v0, l0v1, l1v0, l1v1: TG2Vec3): TG2Float;
  var u, v, w, dp: TG2Vec3;
  var a, b, c, d, e, s, sc, sn, sd, tc, tn, td: TG2Float;
begin
  u := l0v1 - l0v1;
  v := l1v1 - l1v0;
  w := l0v0 - l1v0;
  ...
  if Abs(sn) < G2EPS then sc := 0 else sc := sn / sd;
  if Abs(tn) < G2EPS then tc := 0 else tc := tn / td;
  dp := w + (sc * u) - (tc * v);
  Result := dp.Len;
end;

function G2TriangleArea(const v0, v1, v2: TG2Vec2): TG2Float;
  var d0, d1, d2, s: TG2Float;
begin
  d0 := (v0 - v1).Len;
  d1 := (v1 - v2).Len;
  d2 := (v2 - v0).Len;
...
function G2TriangleArea(const v0, v1, v2: TG2Vec3): TG2Float;
  var d0, d1, d2, s: TG2Float;
begin
  d0 := (v0 - v1).Len;
  d1 := (v1 - v2).Len;
...
procedure G2Vec2Rotation2Mul(const OutV, InV: PG2Vec2; const InR: PG2Rotation2);
  var r: TG2Vec2;
begin
  {$warnings off}
  r.SetValue(
...
procedure G2Vec2Rotation2MulInv(const OutV, InV: PG2Vec2; const InR: PG2Rotation2);
  var r: TG2Vec2;
begin
  {$warnings off}
  r.SetValue(
...
procedure G2Vec2Transform2Mul(const OutV, InV: PG2Vec2; const InT: PG2Transform2);
begin
  {$warnings off}
  OutV^.SetValue(
...
procedure G2Vec2Transform2MulInv(const OutV, InV: PG2Vec2; const InT: PG2Transform2);
  var px, py: TG2Float;
begin
  px := InV^.x - InT^.p.x;
  py := InV^.y - InT^.p.y;
...
procedure G2Rotation2Mul(const OutR, InR1, InR2: PG2Rotation2);
  var r: TG2Rotation2;
begin
  {$warnings off}
  r.SetValue(
...
procedure G2Rotation2MulInv(const OutR, InR1, InR2: PG2Rotation2);
  var r: TG2Rotation2;
begin
  {$warnings off}
  r.SetValue(
...
procedure G2Transform2Mul(const OutT, InT1, InT2: PG2Transform2);
  var rt: TG2Transform2;
begin
  G2Vec2Rotation2Mul(@rt.p, @InT1^.p, @InT2^.r);
  rt.p += InT2^.p;
  G2Rotation2Mul(@rt.r, @InT1^.r, @InT2^.r);
  OutT^ := rt;
end;

procedure G2Transform2MulInv(const OutT, InT1, InT2: PG2Transform2);
  var rt: TG2Transform2;
  var dp: TG2Vec2;
begin
  dp := InT1^.p - InT2^.p;
  G2Vec2Rotation2MulInv(@rt.p, @dp, @InT2^.r);
  G2Rotation2MulInv(@rt.r, @InT1^.r, @InT2^.r);
  OutT^ := rt;
end;
