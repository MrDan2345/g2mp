...
begin
  ...
  _GroundCheckVerts[0] := b2_vec2(qw + qw * 0.18, hh * 0.5);
  _GroundCheckVerts[1] := b2_vec2(-qw - qw * 0.18, hh * 0.5);
  _GroundCheckVerts[2] := b2_vec2(-qw - qw * 0.18, hh + hh * 0.1);
  _GroundCheckVerts[3] := b2_vec2(qw + qw * 0.18, hh + hh * 0.1);
