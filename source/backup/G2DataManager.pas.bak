...
type
  ...
  public
    ...
    procedure WriteStringARaw(const Value: AnsiString);
    ...
    constructor Create(const FileName: String; const Mode: TG2DataMode = dmAsset); overload;
  ...
  public
    ...
    property FName: String read _FName;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    procedure LinkPack(const FileName: String; const Key: AnsiString = '');
...
constructor TG2DataControlFile.Create(const FileName: String; const Mode: TG2DataMode);
begin
  inherited Create;
  {$if defined(G2Target_iOS)}
  case Mode of
...
procedure TG2DataManager.WriteStringARaw(const Value: AnsiString);
begin
...
//TG2Pack BEGIN
procedure TG2Pack.Connect(const FileName: String);
...
procedure TG2PackLinker.LinkPack(const FileName: String; const Key: AnsiString = '');
  var Pack: PG2Pack;
begin
  New(Pack);
