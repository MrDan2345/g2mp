...
//TScene2DEntityData BEGIN
  ...
  public
    ...
    procedure Save(const dm: TG2DataManager);
    procedure Load(const dn: TG2DataManager);
  end;
...
begin
  ...
  //  if od.Execute then
  //  begin
  //    dm := TG2DataManager.Create(od.FileName, dmRead);
  //    try
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    if not PScene2DEntityData(App.Scene2DData.Scene.Entities[i].UserData)^.Selected
...
procedure TScene2DEntityData.Save(const dm: TG2DataManager);
  var i: Integer;
begin
  Entity.Save(dm);
  dm.WriteIntS32(Entity.ChildCount);
  for i := 0 to Entity.ChildCount - 1 do
  begin
    PScene2DEntityData(Entity.Children[i])^.Save(dm);
  end;
end;

procedure TScene2DEntityData.Load(const dn: TG2DataManager);
begin
