...
//TScene2DComponentData BEGIN
  ...
  public
    ...
    procedure AddToProperties(var PropertySet: TPropertySet); virtual;
  end;
...
//TScene2DComponentDataSprite BEIGN
  ...
  public
    ...
    procedure AddToProperties(var PropertySet: TPropertySet); override;
...
//TScene2DData BEGIN
  ...
  private
    ...
    function GetPropertySetPtr: PPropertySet; inline;
  ...
  public
    ...
    var SelPos: TG2Vec2;
    property PropertySetPtr: PPropertySet read GetPropertySetPtr;
...
begin
  ...
  g2.PrimRect(r.x + 2, r.y + 2, r.w - 4, r.h - 4, c1);
  App.UI.Font1.Print(
    r.x + (r.w - App.UI.Font1.TextWidth(Prop.Name)) * 0.5, r.y + (r.h - h) * 0.5, 1, 1,
    $ff000000, Prop.Name, bmNormal, tfPoint
  );
  App.UI.PopClipRect;
end;
...
procedure TUIWorkspaceProperties.OnMouseDown(const Button, x, y: Integer);
  ...
  begin
    ...
    App.UI.TextEdit.Enable(@_EditText, @_TextPos, App.UI.Font1, nil, _EditText, nil, nil);
...
begin
  ...
  begin
    ...
    begin
      if Assigned(TPropertySet.TPropertyButton(Prop).Proc) then
...
begin
  inherited OnInitialize;
  PropertySetPtr := App.Scene2DData.PropertySetPtr;
end;
...
function TUIWorkspaceScene2DStructure.ItemOpen(
  ...
  var ItemData: PScene2DEntityData;
  var i: Integer;
begin
  ItemData := PScene2DEntityData(Item.UserData);
...
begin
  ...
  p := _Display.CoordToScreen(App.Scene2DData.SelPos);
  d := (p - pt).Len;
...
procedure TUIWorkspaceScene2D.OnUpdate;
  ...
  var r0, r1, r: TG2Rotation2;
  var DragSelOffset: TG2Vec2;
  var i: Integer;
begin
  ...
  begin
    DragSelOffset := cp - _DraggingSelectionPos;
    xf.SetIdentity;
    xf.p := _Display.CoordToScreen(App.Scene2DData.SelPos);
    if _DraggingSelectionPosX then
    begin
      xf.p.x := xf.p.x + DragSelOffset.x;
    end;
    if _DraggingSelectionPosY then
    begin
      xf.p.y := xf.p.y + DragSelOffset.y;
    end;
    if _DraggingSelectionRot then
    begin
      r0.AxisX := (_DraggingSelectionPos - xf.p).Norm;
      r1.AxisX := (cp - xf.p).Norm;
      xf.r.Angle := r1.Angle - r0.Angle;
    end;
    xf.p := _Display.CoordToDisplay(xf.p) - App.Scene2DData.SelPos;
    for i := 0 to App.Scene2DData.Selection.Count - 1 do
    if (App.Scene2DData.Selection[i].Parent = nil)
    or (not PScene2DEntityData(App.Scene2DData.Selection[i].Parent.UserData)^.Selected) then
    begin
      xf1 := App.Scene2DData.Selection[i].Transform;
      r := xf1.r;
      G2Rotation2Mul(@r, @r, @xf.r);
      p := xf1.p - App.Scene2DData.SelPos;
      G2Vec2Rotation2Mul(@p, @p, @xf.r);
      p += App.Scene2DData.SelPos + xf.p;
      xf1.SetValue(p, r);
      App.Scene2DData.Selection[i].Transform := xf1;
    end;
    App.Scene2DData.UpdateSelectionPos;
    _DraggingSelectionPos := cp;
  end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          _DraggingSelectionOffset := _Display.CoordToScreen(App.Scene2DData.SelPos) - _DraggingSelectionPos;
        end
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          and Frame.Contains(g2.MouseDownPos[Button])
          and ((G2Vec2(x, y) - g2.MouseDownPos[Button]).Len < 2) then
          begin
...
begin
  ...
  begin
    ...
    begin
      _ParticleTextureFile.FilePath := Emitter.Texture.TextureFileName;
...
begin
  ...
  if Texture <> nil then
  begin
    dm.WriteStringA(Texture.TextureFileName);
...
begin
  ...
  begin
    ...
    Texture.Load(dm);
    Texture.TextureFileName := TexName;
  end;
...
procedure TParticleData.Render;
  ...
  begin
    ...
    g2ml.NodeValue('frame', ExtractFileName(e.Texture.TextureFileName))
    else
...
procedure TScene2DEditorPoly.OnModeClick;
begin
  SetUpPopUpModes;
  _PopUp.Show(g2.MousePos);
end;

procedure TScene2DEditorPoly.OnFlipEdgeClick;
  var f: array[0..1] of TScene2DComponentDataPolyFace;
  var e: TScene2DComponentDataPolyEdge;
...
procedure TScene2DEditorPoly.OnCollapseClick;
  var i, j, n: Integer;
  var f: TScene2DComponentDataPolyFace;
...
begin
  Result := _Drag and (_SelectVertex.Count = 0) and (_SelectEdge.Count = 0) and (_SelectFace.Count = 0);
end;
...
begin
  ...
  begin
    ...
    //begin
    //  _MOverVertex.v := mc + _VOffset[0];
    //end
    //else if _MOverEdge <> nil then
    //begin
    //  _MOverEdge.v[0].v := mc + _VOffset[0];
    //  _MOverEdge.v[1].v := mc + _VOffset[1];
    //end
    //else if _MOverFace <> nil then
    //begin
    //  _MOverFace.v[0].v := mc + _VOffset[0];
    //  _MOverFace.v[1].v := mc + _VOffset[1];
    //  _MOverFace.v[2].v := mc + _VOffset[2];
    //end;
  end
  else
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            StartDrag(Display.CoordToDisplay(G2Vec2(x, y)));
          end
          else
          begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        r.x := Display.ViewPort.Left + r.x;
        r.y := Display.ViewPort.Bottom + r.y;
        if r.Contains(x, y) then Buttons[i].OnClick;
      end;
      if (_MdInVertex <> nil)
...
procedure TScene2DComponentData.AddToProperties(var PropertySet: TPropertySet);
begin
...
procedure TScene2DComponentDataSprite.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
...
procedure TScene2DComponentDataBackground.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
  var Enum: TPropertySet.TPropertyEnum;
begin
...
procedure TScene2DComponentDataPoly.AddToProperties(var PropertySet: TPropertySet);
begin
  Group := PropertySet.PropComponent(GetName, Component);
  PropertySet.PropButton('Add Layer', @OnAddLayer, Group);
...
procedure TScene2DComponentDataEffect.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
begin
...
procedure TScene2DComponentDataRigidBody.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
  var Enum: TPropertySet.TPropertyEnum;
begin
...
procedure TScene2DComponentDataShapePoly.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
begin
...
procedure TScene2DComponentDataShapeBox.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
begin
...
procedure TScene2DComponentDataShapeCircle.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
begin
...
procedure TScene2DComponentDataShapeEdge.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
begin
...
procedure TScene2DComponentDataShapeChain.AddToProperties(var PropertySet: TPropertySet);
  var Group: TPropertySet.TProperty;
begin
...
procedure TScene2DJointData.AddToProperties(var PropertySet: TPropertySet);
begin
...
//TScene2DData BEIGN
function TScene2DData.GetPropertySetPtr: PPropertySet;
begin
  Result := @_PropertySet;
end;
...
begin
  ...
  EntityData := PScene2DEntityData(Entity.UserData);
  if PropertySet = EntityData^.Properties then
  PropertySet := nil;
  if EntityData^.Selected then
  begin
    SelectionUpdateStart;
    Selection.Remove(Entity);
    SelectionUpdateEnd;
  end;
  EntityData^.Properties.Free;
  Dispose(EntityData);
  Entity.Free;
  Entity := nil;
end;
...
begin
  for i := 0 to Selection.Count - 1 do
  PScene2DEntityData(Selection[i].UserData)^.Selected := False;
end;
...
begin
  ...
  Selection.Clear;
  for i := 0 to Selection.Count - 1 do
  PScene2DEntityData(Selection[i].UserData)^.Selected := True;
  UpdateSelectionPos;
  if Selection.Count = 1 then
  begin
    PScene2DEntityData(Selection[0].UserData)^.UpdateProperties;
...
begin
  SelPos.SetZero;
  for i := 0 to Selection.Count - 1 do
  SelPos += Selection[i].Transform.p;
  SelPos *= 1 / Selection.Count;
end;
...
begin
  if Selection.Count = 1 then
  PScene2DEntityData(Selection[0].UserData)^.SyncProperties;
end;
