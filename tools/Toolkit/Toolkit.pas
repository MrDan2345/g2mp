...
procedure TScene2DEditorPoly.Render(const Display: TG2Display2D);
  var i, j, l: Integer;
  var varr: array[0..2] of TG2Vec2;
  var v, v0, v1, pv0, pv1, mc, pmc, pn, n, t: TG2Vec2;
  var xf: TG2Transform2;
  var b: Boolean;
  var c, c1: TG2Color;
  var r: TG2Rect;
...
begin
  ...
  LayersSorted.Add(_Component.Layers[i], _Component.Layers[i].Layer + i * 0.00001);
...
begin
  Properties := PScene2DEntityData(Component.Owner.UserData)^.Properties;
  Group.Clear;
  for i := 0 to Layers.Count - 1 do
  begin
    ...
    Layers[i].ScaleProp := Properties.PropVec2('Scale', @Layers[i].Scale, LayerGroup);
  end;
